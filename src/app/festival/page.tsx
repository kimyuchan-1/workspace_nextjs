...
import type { FestivalData } from './festivalData'
...
export default function Festival() {
    ...
    useEffect(()=>{
        ...
        <Link href={`/festival/content?item=${encodeURIComponent(JSON.stringify(item))}`} key = {item.UC_SEQ+idx}  >
    ...
    return (
        <div className='w-full flex flex-col justify-start items-center p-3'>
            ...
            <select className='border-solid border border-gray-500 m-3 p-1 w-3/10 text-left text-sm rounded-sm'
                    name = "district"
